...
// 「要不要升级、升到哪个版本」由服务端经 HTTP CheckFirmwareUpdate RPC 回答(见 backend proto/companion_device.proto),
...
public:
    ...
    // 下载固件并校验后刷写。expected_sha256_hex / expected_size 来自 HTTP CheckFirmwareUpdate 响应
