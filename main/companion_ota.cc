...
std::string CompanionOta::GetCurrentVersion() {
    auto app_desc = esp_app_get_description();
    return app_desc->version;
}

void CompanionOta::MarkCurrentVersionValid() {
...
bool CompanionOta::Upgrade(const std::string& firmware_url,
